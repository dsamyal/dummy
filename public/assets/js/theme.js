...
(function ($) {
    ...
    /*$('.main-page-user-click').on("click",function(e) {
        ...
        $.ajax({
            type: "POST",
            url: url,
            data: {type:"user", user_id:user_id, gallery_view: type_switch_two},
	...
	$('.main-page-user-click').on("click",function(e) {
        ...
        $.ajax({
            ...
            {
            	// return false;
            	window.location.href = home_url+"/"+tagname;
                // window.location.reload();
            }
        });
	});

	jQuery(".details__filter").click(function(){
		jQuery("#main-search-filter").val(jQuery(this).text());
        jQuery('.ctm__product_details_form').submit();
    });

	jQuery("#search_close").click(function(e){
		e.preventDefault();
		var home_url_header = jQuery("#home_url_header").val();
		jQuery("#main-search-filter").val('');
		window.location.href = home_url_header+'/index';
	});
	...
	function updatePost(){
		...
		$.ajax({
			url: 'index.php/site/check-post/'+count,
			type: 'GET',
			success: function(response) {
