...
@section('content')
    <style>  
        ...
        /*button.owl-prev.disabled,button.owl-next.disabled, button.owl-next, button.owl-prev{
            background: transparent !important;
        }*/
        .owl-stage-outer { width: calc( 100% - 15px);/*margin-left: 40px;*/ overflow: hidden; position: relative; z-index: 9999999;}
        ...
        .owl-prev { float: left; }
        /*.owl-prev:hover { float: left; background-image:url("../assets/img/Icon-01.png") !important; }*/
        .owl-prev.disabled , .owl-next.disabled { display: none;}
        .owl-next {  float: right; }
        /*.owl-next:hover {  float: right; background-image:url("../assets/img/Icon-02.png") !important;  }*/
                        ...
                        <div class="menu-wrapper subcategory">
                            <div class="owl-carousel_1 owl-theme col-xs-12 text-left filter-tags-bar menu ">
                                @foreach($subcategories as $count => $subcategory)
                                    <div class="item filter-gallery-groups filter-gallery-toggle-category @if($filter_subvalue && in_array($subcategory->title,$filter_subvalue)) filter-gallery-toggle-active @endif" data-cat-type="subcat" data-filter-type="type" data-type="{{ $filter_value }}" data-subtype="{{ $subcategory->title }}" tabindex="{{ $count+1 }}">{{ $subcategory->title }}</div>
                                @endforeach
                            </div>
