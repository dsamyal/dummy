        ...
        <table style="width: 600px; height: 100%; margin-left: auto; margin-right: auto; border-radius:20px; border:2px solid #666; padding: 50px 0 100px 0"> 
            <tbody>
                ...
                <tr style="text-align: center; color:#666;">
                    <td><span style="font-size: 14px; font-family: AvenirNextCondensed, sans-serif; letter-spacing: 2px;">Your username/Email information is updated.</span></td>
                </tr> 
                <tr style="text-align: center;">
                    <td style="padding-top:50px;">
                        <p><span><a style="font-size: 14px; font-family: AvenirNextCondensed, sans-serif; letter-spacing: 2px; color: #fff; background-color:#666; padding:20px; border-radius:10px; text-decoration: none;" href="www.nameemailverificationlink://">Open app and log in</a></span></p> 
                    </td>
                </tr>
            </tbody>
        </table>
